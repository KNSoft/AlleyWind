...
/**
  ...
  * @return Returns NTSTATUS
  */
NTA_API NTSTATUS NTAPI IO_WriteStringW(HANDLE FileHandle, LPWSTR lpsz);
NTA_API NTSTATUS NTAPI IO_WriteStringA(HANDLE FileHandle, LPSTR lpsz);
#ifdef UNICODE
...
/**
  ...
  * @return Returns NTSTATUS
  */
NTA_API NTSTATUS NTAPI IO_WriteLineW(HANDLE FileHandle, LPWSTR lpsz);
NTA_API NTSTATUS NTAPI IO_WriteLineA(HANDLE FileHandle, LPSTR lpsz);
#ifdef UNICODE
