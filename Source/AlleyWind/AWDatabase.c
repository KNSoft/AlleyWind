...
// CS_*
DLG_VALUEEDITOR_CONSTW stCSDVEConsts[] = {
...
// WS_*
DLG_VALUEEDITOR_CONSTW stWSDVEConsts[] = {
...
// DS_* for dialog box
DLG_VALUEEDITOR_CONSTW stDSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stACSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stDTSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stMCSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stPBSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stRBSDVEConsts[] = {
...
// TTS_* for Tooltip
DLG_VALUEEDITOR_CONSTW stTTSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stTBSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stUDSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stBSDVEConsts[] = {
...
// CBS_* for Combo Box
DLG_VALUEEDITOR_CONSTW stCBSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stCBESDVEConsts[] = {
    { CBS_DROPDOWNLIST, L"CBS_DROPDOWNLIST", NULL },
    { CBS_DROPDOWN, L"CBS_DROPDOWN", NULL },
    { CBS_SIMPLE, L"CBS_SIMPLE", NULL }
};
...
DLG_VALUEEDITOR_CONSTW stESDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stHDSDVEConsts[] = {
...
// LBS_* for List Box
DLG_VALUEEDITOR_CONSTW stLBSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stLWSDVEConsts[] = {
...
// LVS_* for List-View
DLG_VALUEEDITOR_CONSTW stLVSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stPGSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stSBSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stSSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stTCSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stTVSDVEConsts[] = {
...
DLG_VALUEEDITOR_CONSTW stMDISDVEConsts[] = {
...
PAW_SYSCLASSINFO AW_DBFindSysClassInfoByName(LPTSTR lpszClassName) {
    ...
    for (i = 0; i < ARRAYSIZE(aAWSysCtlLib); i++) {
        ...
        if (Str_CchEqualEx(lpszClassName, MAX_CLASSNAME_CCH, lpszName, MAX_CLASSNAME_CCH))
...
BOOL AW_DBEditValue(HWND hDlg, HWND hWnd, AW_VALUETYPE eType, PDWORD lpdwValue) {
    ...
    if (eType == AWValueStyle) {
        PDLG_VALUEEDITOR_CONSTW lpstConstsTemp, lpstConstsSysClass;
        ...
        return FALSE;
    if (Dlg_ValueEditorW(hDlg, DVE_TYPE_COMBINATION | DVE_VALUE_HEXDWORD, lpszDVE, &qwValue, lpstConsts, uConsts)) {
