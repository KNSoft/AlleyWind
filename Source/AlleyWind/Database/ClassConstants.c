...
// CCS_* for Rebar, Status Bar and Tool Bar
static UI_VALUEEDITOR_CONSTANT CCSConsts[] = {
    DEFINE_CONSTANT(CCS_TOP, NULL),
    DEFINE_CONSTANT(CCS_NOMOVEY, NULL),
    DEFINE_CONSTANT(CCS_BOTTOM, NULL),
    DEFINE_CONSTANT(CCS_NORESIZE, NULL),
    DEFINE_CONSTANT(CCS_NOPARENTALIGN, NULL),
    DEFINE_CONSTANT(CCS_ADJUSTABLE, NULL),
    DEFINE_CONSTANT(CCS_NODIVIDER, NULL),
    DEFINE_CONSTANT(CCS_VERT, NULL),
    DEFINE_CONSTANT(CCS_LEFT, NULL),
    DEFINE_CONSTANT(CCS_RIGHT, NULL),
    DEFINE_CONSTANT(CCS_NOMOVEX, NULL),
};
...
// CBES_EX_* for ComboBoxEx Control
static UI_VALUEEDITOR_CONSTANT CBESConsts[] = {
    DEFINE_CONSTANT(CBES_EX_CASESENSITIVE, NULL),
    DEFINE_CONSTANT(CBES_EX_NOEDITIMAGE, NULL),
    DEFINE_CONSTANT(CBES_EX_NOEDITIMAGEINDENT, NULL),
    DEFINE_CONSTANT(CBES_EX_NOSIZELIMIT, NULL),
    DEFINE_CONSTANT(CBES_EX_PATHWORDBREAKPROC, NULL),
    DEFINE_CONSTANT(CBES_EX_TEXTENDELLIPSIS, NULL),
};
...
static AW_SYSCLASS_INFO g_astSysClassInfo[] = {
    ...
    DEFINE_CLASS_INFO_1(TOOLBARCLASSNAMEW, ToolBar, TBSTYLEConsts),
...
{
    UINT i;
    WCHAR szClassOrdName[7]; // e.g. "#65535"
    PCWSTR pszName;
